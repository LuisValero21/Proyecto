        ...
        <table class="w-full border">
            ...
            <tbody>
                ...
                <tr class="bg-gray-100 border-b">
                    ...
                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                        <?php echo ($row['Rol_Descripcion']) ?>
                    </td>
                    <td>
                        <form method="post" enctype="multipart/form-data">
                            <input type="hidden" name="Cargo_ID" value="<?php echo $row['Rol_ID']; ?>">
                            <a class="bg-blue-500 p-2 text-white hover:shadow-lg text-xs font-thin" href="modificarRoles.php?id=<?php echo $row['Rol_ID']; ?>">Edit</a>
